            ...
            try {
                ...
                for(int i = 0; i < list.size(); i++){
                    ...
                    if (response1.isSuccessful()) {
                        ...
                        Weather weather = new Weather(city.getId(), (int) (currentWeatherResponseDTO.getMain().getTemp() - 273.15), (int)(currentWeatherResponseDTO.getMain().getFeels_like() - 273.15), currentWeatherResponseDTO.getWeather().get(0).getMain(), currentWeatherResponseDTO.getWeather().get(0).getDescription());
                ...
                out.println("<p><b> The coldest city is " + CityDAO.cityByID(weather1.getCity_id()).getName() + ": </b> " +
                ...
                for(int i = 0; i < weathers.size(); i++) {
                    if(weathers.get(i).city_id != weather.city_id && weathers.get(i).city_id != weather1.city_id) {
                        out.println("<p><b>" + CityDAO.cityByID(weathers.get(i).getCity_id()).getName() + ": </b> " +
